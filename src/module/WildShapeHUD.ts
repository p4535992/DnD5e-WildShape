...
export class WildShapeHUD {
	static async addWildShapeHUDButtons(app, html, data) {
			...
			tbutton.find('i').click(async (ev) => {
				...
				if (tbutton === tbuttonWildShape1) {
					...
					if (statusWildShape1) {
						...
						console.log("Clicked on the wildshape button when the shape is on.");
						...
						console.log("Clicked on the wildshape button when the shape is off.");
                    ...
                    console.error("tbutton is not equal to any wildshape");
		...
		let tbuttonWildShape1   = $(`<div class="control-icon foundryvtt-dnd5e-wildshape" title="Toggle WildShape Spell"><i class="fas fa-sun"></i></div>`);
		// let tbuttonWildShape2 = $(`<div class="control-icon foundryvtt-dnd5e-wildshape" title="Toggle Lantern"><i class="fas fa-lightbulb"></i></div>`);
		// let tbuttonWildShape3   = $(`<div class="control-icon foundryvtt-dnd5e-wildshape" title="Toggle Torch"><i class="fas fa-fire"></i></div>`);
...
*/
		...
		//console.log("Initial statusWildShape1:" + statusWildShape1);
		...
		// //console.log("Initial statusWildShape2:" + statusWildShape2);
		...
		// //console.log("Initial statusWildShape3:" + statusWildShape3);
		...
		// }
		//console.log("Initialised statusWildShape1:" + statusWildShape1);
		//console.log("Initialised statusWildShape2:" + statusWildShape2);
		//console.log("Initialised statusWildShape3:" + statusWildShape3);
